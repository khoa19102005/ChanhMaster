...
module.exports = (client, message, args, cmd, prefix) => {
  if (cmd === "lock") {
    ...
    if (!channel) return message.reply(new Discord.MessageEmbed()
      ...
      .setTitle(":x: Bạn phải vô VoiceChannel")
    ...
    if (client.jointocreatemap.get(`tempvoicechannel_${message.guild.id}_${channel.id}`)) {
      ...
      if (!owner)
        return message.reply(new Discord.MessageEmbed()
          .setColor(ee.wrongcolor)
          .setTitle(":x: Bạn phải có quyền chủ phòng **temp.** VoiceChannel!")
          .setFooter(ee.footertext, ee.footericon)
        )
      vc.overwritePermissions([{
        ...
        .then(lol => {
          ...
          return message.reply(new Discord.MessageEmbed()
            .setColor(ee.color)
            .setTitle("✅ Đã khoá!")
            .setDescription(`Không ai có thể vô được nữa!`)
            .setFooter(ee.footertext, ee.footericon)
          )
        })
    ...
    if (client.jointocreatemap.get(`tempvoicechannel_${message.guild.id}_${channel.id}`)) {
      ...
      vc.updateOverwrite(message.guild.id, {
        ...
        return message.reply(new Discord.MessageEmbed()
          .setColor(ee.color)
          .setTitle("✅ Mở khoá phòng!")
          .setDescription(`Mọi người có thể vô!`)
          .setFooter(ee.footertext, ee.footericon)
        )
      })
    } else {
    ...
    if (client.jointocreatemap.get(`tempvoicechannel_${message.guild.id}_${channel.id}`)) {
      ...
      if (!owner)
        return message.reply(new Discord.MessageEmbed()
          .setColor(ee.wrongcolor)
          .setTitle(":x: Bạn phải có quyền chủ **temp.** VoiceChannel!")
          .setFooter(ee.footertext, ee.footericon)
        )
    ...
    if (client.jointocreatemap.get(`tempvoicechannel_${message.guild.id}_${channel.id}`)) {
      ...
      if (!owner)
        return message.reply(new Discord.MessageEmbed()
          .setColor(ee.wrongcolor)
          .setTitle(":x: Bạn phải là chủ phòng **temp.** VoiceChannel!")
          .setFooter(ee.footertext, ee.footericon)
        )
      if (!args[0]) return message.reply(new Discord.MessageEmbed()
        .setColor(ee.wrongcolor)
    ...
    if (client.jointocreatemap.get(`tempvoicechannel_${message.guild.id}_${channel.id}`)) {
      ...
      if (!args[0]) return message.reply(
        ...
        .setColor(ee.wrongcolor)
        .setFooter(ee.footertext, ee.footericon)
        .setTitle(":x: Phải thêm limit")
      );
      if (isNaN(args[0])) return message.reply(
        new Discord.MessageEmbed()
        .setColor(ee.wrongcolor)
        .setFooter(ee.footertext, ee.footericon)
        .setTitle(":x: Phải là **Số**")
      );
